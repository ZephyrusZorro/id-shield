...
export function EvidenceFusionMatrix({ rows }: EvidenceFusionMatrixProps) {
  if (!rows || rows.length === 0) {
    return (
      <div className="card p-8 text-center text-xs text-slate-400 dark:text-slate-500">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card flex flex-wrap items-center justify-between gap-4 p-4 border-slate-200/90 dark:border-slate-800 bg-gradient-to-r from-blue-50/50 via-indigo-50/30 to-purple-50/20 dark:from-blue-950/20 dark:via-indigo-950/20 dark:to-purple-950/10">
        ...
        <div className="flex items-center gap-3">
          <div className="rounded-lg bg-emerald-50 dark:bg-emerald-950/60 px-3 py-1.5 ring-1 ring-inset ring-emerald-500/30">
          ...
          {conflictCount > 0 && (
            <div className="rounded-lg bg-rose-50 dark:bg-rose-950/60 px-3 py-1.5 ring-1 ring-inset ring-rose-500/30">
      ...
      <div className="card overflow-hidden border border-slate-200/90 dark:border-slate-800 shadow-sm">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="border-b border-slate-200/80 dark:border-slate-800 bg-slate-50/90 dark:bg-slate-900/80 font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 text-[11px]">
              <tr>
              ...
              {rows.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      {row.qr_value ? (
                        <div>
                          ...
                          <span className="mt-0.5 inline-flex items-center gap-1 text-[10px] font-bold text-purple-600 dark:text-purple-400">
                    ...
                    <td className="px-5 py-4">
                      {row.mrz_value ? (
                        <div>
                          ...
                          <span className="mt-0.5 inline-flex items-center gap-1 text-[10px] font-bold text-amber-600 dark:text-amber-400">
                    ...
                    <td className="px-5 py-4">
                      {isUnanimous ? (
                        <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-2.5 py-0.5 text-xs font-bold text-emerald-700 ring-1 ring-inset ring-emerald-500/20 dark:bg-emerald-950/60 dark:text-emerald-300">
                          <CheckCircle2 size={13} /> Unanimous Consensus
                        </span>
                      ) : row.agreement_status === "majority_conflict" ? (
                        <div>
                          <span className="inline-flex items-center gap-1.5 rounded-full bg-rose-100 px-2.5 py-0.5 text-xs font-extrabold text-rose-800 ring-1 ring-inset ring-rose-500/30 dark:bg-rose-950 dark:text-rose-200">
                        ...
                        <span className="inline-flex items-center gap-1.5 rounded-full bg-rose-100 px-2.5 py-0.5 text-xs font-bold text-rose-800 dark:bg-rose-950 dark:text-rose-200">
        ...
        <div className="border-t border-slate-100 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/40 px-5 py-3 text-xs text-slate-500 dark:text-slate-400 flex items-center justify-between">
          <span>
